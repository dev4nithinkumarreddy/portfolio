...
const skills = ["PYTHON", "REACT", "JS", "SQL", "FAST API"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Building robust and scalable applications from the frontend to the 
            backend. Transforming complex problems into elegant, efficient, and 
