...
const socialLinks = [
  {
    ...
    user: '@captain_nithin',
    icon: FaInstagram,
    link: 'https://www.instagram.com/captain_nithin?igsh=MTU3MmszZTllaHA4OQ==',
  },
  {
    title: 'Github',
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: '7ecbd0a2-ab0e-452e-a42e-328dbbea5438', // User needs to replace this
          name,
          email,
          message,
        }),
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-white/10 pt-5 mt-6">
        ...
        {/* LINKEDIN */} 
        <motion.a
          href="https://www.linkedin.com/in/c-nithin-kumar-reddy-978b052a9?utm_source=share_via&utm_content=profile&utm_medium=member_ios"  
          target="_blank"
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/35">@c-nithin-kumar-reddy</p>
            </div>
          </div>
