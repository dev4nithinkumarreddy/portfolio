...
import { Upload, Heart, Pin, MessageSquare } from 'lucide-react'
      ...
      >
        <div className="space-y-3 h-full">
          {comments.length === 0 && !loading && (
            <div className="flex flex-col items-center justify-center h-full text-white/50 text-center py-24">
              <MessageSquare size={36} className="mb-4 opacity-50" />
              <h4 className="text-sm font-medium text-white/70">No comments yet</h4>
              <p className="text-xs mt-1 text-white/40">Be the first to share your thoughts!</p>
            </div>
          )}
